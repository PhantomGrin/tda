function renderd3tree(blocker,victims){
    var data={}
    // victims=JSON.parse(victims)
    var children=[]
    data["name"]=blocker;
    for (victim in victims){
        var jsondata={}
        jsondata["name"]=victims[victim];
        children.push(jsondata)

    }
    data["children"]=children;
    console.log(data)
    rendersyncblocker(data);
}

function rendersyncblocker(data){
    ...
    function update(source) {
        tree(root);
        root.each(function(d) { d.y = d.depth * 200; });
